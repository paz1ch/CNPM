...
router.get('/analytics/revenue', protect, orderController.getRevenueAnalytics); // Admin route
...
// Internal routes
router.get('/internal/restaurant/:restaurantId/check', orderController.checkRestaurantOrders);
